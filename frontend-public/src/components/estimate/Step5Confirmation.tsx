      ...
      <div className="space-y-1.5 print:hidden">
        ...
        <div className="flex flex-col gap-1.5 pt-2">
          ...
          <button
            ...
            className="w-full py-2 text-xs text-neutral-700 hover:text-black hover:bg-neutral-100 border border-neutral-300 rounded-lg transition-colors font-medium"
          >
