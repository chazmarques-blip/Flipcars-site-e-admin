// ============================================
// MOCKUP CALENDAR - STANDALONE SCRIPT
// Loaded directly from public/ to avoid Next.js tree-shaking
// ============================================

console.log('📅 Loading mockup-calendar.js...');
...
function confirmReschedule(eventId, sourceDate, newTime) {
...
// INITIALIZATION
// ============================================
function initializeMockupCalendar() {
  console.log('✅ Initializing mockup calendar...');
