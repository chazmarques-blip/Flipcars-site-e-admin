    ...
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="w-full px-3 py-1.5 text-xs border border-neutral-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-gold outline-none transition-colors resize-none"
        />
