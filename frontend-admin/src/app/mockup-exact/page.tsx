...
export default function MockupExactPage() {
  useEffect(() => {
    // Load external script from public/
    const script = document.createElement('script');
    script.src = '/mockup-calendar.js';
    script.async = true;
    script.onload = () => {
      console.log('✅ mockup-calendar.js loaded successfully');
    };
    script.onerror = () => {
      console.error('❌ Failed to load mockup-calendar.js');
    };
