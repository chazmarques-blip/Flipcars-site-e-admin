...
export default function MockupExactPage() {
  useEffect(() => {
    console.log('🟢 useEffect EXECUTADO! Chamando initializeMockup...');
    // Initialize mockup JavaScript logic after mount
    initializeMockup();
    console.log('🟢 initializeMockup() retornou!');
...
function initializeMockup() {
  ...
  console.log('🔍 EventsByDate entries:', Object.keys(eventsByDate).length);
