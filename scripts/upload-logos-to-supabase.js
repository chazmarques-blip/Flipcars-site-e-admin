...
// Insurance company logos to upload
const insuranceLogos = [
  { file: 'insurance-allstate.png', company: 'Allstate' },
  { file: 'insurance-american-family.png', company: 'American Family' },
  { file: 'insurance-erie.png', company: 'Erie Insurance' },
  { file: 'insurance-farmers.png', company: 'Farmers Insurance' },
  { file: 'insurance-geico.png', company: 'Geico' },
  { file: 'insurance-liberty-mutual.png', company: 'Liberty Mutual' },
  { file: 'insurance-nationwide.png', company: 'Nationwide' },
  { file: 'insurance-progressive.png', company: 'Progressive' },
  { file: 'insurance-statefarm.png', company: 'State Farm' },
  { file: 'insurance-travelers.png', company: 'Travelers' },
  { file: 'insurance-usaa.png', company: 'USAA' },
];
